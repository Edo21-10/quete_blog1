...
class __TwigTemplate_c80d562db8c5b4f2c390b358fca5182702e438fc93421739c029e613263249a9 extends \Twig\Template
{
    private $source;
...
";
        // line 12
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["revision"]) || array_key_exists("revision", $context) ? $context["revision"] : (function () { throw new RuntimeError('Variable "revision" does not exist.', 12, $this->source); })()), "timestamp", [], "any", false, false, false, 12)), "html", null, true);
        echo "
";
...
", "@SonataAdmin/CRUD/history_revision_timestamp.html.twig", "/var/www/html/quete_blog1/vendor/sonata-project/admin-bundle/src/Resources/views/CRUD/history_revision_timestamp.html.twig");
    }
}
