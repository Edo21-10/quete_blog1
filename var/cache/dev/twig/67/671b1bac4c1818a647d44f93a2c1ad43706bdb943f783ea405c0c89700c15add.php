...
class __TwigTemplate_e3c53ccd444b1394dab14bdb1da90176eafdcd07f62d6df51899d8aa8ccb54be extends \Twig\Template
{
    private $source;
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["element"]) {
                ...
                ";
                    ...
                    if (twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, $context["element"], "children", [], "any", false, false, false, 32))) {
                        // line 33
                        echo "                    ";
                        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $this->getTemplateName(), "navigate_child", [0 => twig_get_attribute($this->env, $this->source, $context["element"], "children", [], "any", false, false, false, 33), 1 => (isset($context["admin"]) || array_key_exists("admin", $context) ? $context["admin"] : (function () { throw new RuntimeError('Variable "admin" does not exist.', 33, $this->source); })()), 2 => false], "method", false, false, false, 33), "html", null, true);
                        echo "
                ";
                    }
                    // line 35
...
{% endblock %}
", "@SonataAdmin/CRUD/tree.html.twig", "/var/www/html/quete_blog1/vendor/sonata-project/admin-bundle/src/Resources/views/CRUD/tree.html.twig");
    }
}
