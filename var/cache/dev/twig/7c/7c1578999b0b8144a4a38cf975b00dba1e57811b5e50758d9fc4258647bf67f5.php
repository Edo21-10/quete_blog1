...
class __TwigTemplate_358ad16781f12dc1b6a745e66b3726fcac8bb52e74ab13a5c0b91d945c774c58 extends \Twig\Template
{
    private $source;
...
{% if admin.hasAccess('create') and admin.hasRoute('create') %}
    ...
    {% endif %}
{% endif %}
", "@SonataAdmin/Button/create_button.html.twig", "/var/www/html/quete_blog1/vendor/sonata-project/admin-bundle/src/Resources/views/Button/create_button.html.twig");
    }
}
