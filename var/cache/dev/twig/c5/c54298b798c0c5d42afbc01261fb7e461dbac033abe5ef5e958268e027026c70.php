...
class __TwigTemplate_e69fc1430f7b523fdb384140195a15959f87f1ac86c99d80b0aa4556fb5205bf extends \Twig\Template
{
    private $source;
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["nested_group_field"]) {
            ...
            foreach ($context['_seq'] as $context["name"] => $context["form_group"]) {
                ...
                // line 37
                $context['_parent'] = $context;
                $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, $context["form_group"], "fields", [], "any", false, false, false, 37));
                foreach ($context['_seq'] as $context["_key"] => $context["field_name"]) {
                    if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["nested_group_field"], "children", [], "any", false, true, false, 37), $context["field_name"], [], "array", true, true, false, 37)) {
                        // line 38
                        echo "                                        ";
...
", "@SonataAdmin/CRUD/Association/edit_one_to_many_inline_tabs.html.twig", "/var/www/html/quete_blog1/vendor/sonata-project/admin-bundle/src/Resources/views/CRUD/Association/edit_one_to_many_inline_tabs.html.twig");
    }
}
